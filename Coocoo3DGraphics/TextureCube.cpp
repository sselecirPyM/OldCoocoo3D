...
void TextureCube::ReloadAsRTVUAV(int width, int height, int mipLevels, DxgiFormat format)
{
	m_width = width;
	m_height = height;
...
void TextureCube::ReloadAsDSV(int width, int height, DxgiFormat format)
{
	m_width = width;
	m_height = height;
	m_mipLevels = 1;

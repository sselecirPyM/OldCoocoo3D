...
namespace Coocoo3D.RenderPipeline
{
    public static class SkinningCompute
    {
        public static void Process(RenderPipelineContext context)
        {
            ...
            //    SetPipelineStateVariant(graphicsDevice, graphicsContext, rpAssets.rootSignatureSkinning, context.SkinningDesc, psoSkinning);
        ...
        private static void SetPipelineStateVariant(GraphicsDevice graphicsDevice, GraphicsContext graphicsContext, RootSignature graphicsSignature, PSODesc desc, PSO pso)
        {

...
namespace Coocoo3DGraphics1
{
    public class PipelineStateObject : IDisposable
    {
        ...
        {
            this.vertexShader = vertexShader.compiledCode.GetBytes();
            this.pixelShader = pixelShader.compiledCode.GetBytes();
        }
        ...
        public ID3D12PipelineState GetState(GraphicsDevice device, PSODesc desc, RootSignature rootSignature, UnnamedInputLayout inputLayout)
        {
            ...
            {
                graphicsPipelineStateDescription.RenderTargetFormats[i] = desc.RenderTargetFormat;
            }
